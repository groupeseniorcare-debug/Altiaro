    ...
    <Layout>
      <div className="p-8 md:p-12 max-w-[1400px]">
        <div className="flex items-start justify-between mb-10 animate-fade-up">
          <div>
            <div className="text-[11px] uppercase tracking-widest text-zinc-500 mb-2">Portefeuille</div>
        ...
        {loading ? (
          ...
          <div className="bg-zinc-950 rounded-xl border border-zinc-800 p-12 text-center">
            ...
            <button
              ...
              className="h-11 px-5 rounded-xl bg-white hover:bg-zinc-200 text-black font-medium inline-flex items-center gap-2 transition"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {sites.map((s, i) => (
              <div
                ...
                className={`bg-zinc-950 rounded-xl border border-zinc-800 p-6 cursor-pointer hover:border-[#B84B31]/40 hover:shadow-md transition-all duration-250 animate-fade-up-delay-${Math.min(i + 1, 4)}`}
              >
                ...
                <h3 className="text-lg font-semibold text-zinc-100 mb-1">{s.name}</h3>
                <div className="text-sm text-zinc-500 mb-4 line-clamp-2">{s.niche}</div>

                <div className="mb-2 flex justify-between text-xs text-zinc-500">
                  <span>Avancement</span>
                  <span className="font-medium text-zinc-100">{s.progress_pct}%</span>
                </div>
                ...
                <div className="flex items-center justify-between pt-3 border-t border-zinc-900">
                  ...
                  <ArrowRight size={16} className="text-zinc-100" />
                </div>
              </div>
            ))}
          </div>
