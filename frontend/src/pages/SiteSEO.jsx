...
import {
  ArrowClockwise, CheckCircle, Warning, Info,
  GoogleLogo, Storefront, ShieldCheck,
...
export default function SiteSEO() {
  ...
  return (
    <StepLayout
      siteId={siteId}
      stepKey="seo"
      title="Référencement automatisé"
      subtitle={
        allHandled
          ? "Ton site est entièrement optimisé. Aucune action technique requise."
          : "Il reste à activer le suivi Google avant la mise en ligne."
      }
      estimatedTime="~2 min"
      whatItDoes="Altiaro applique automatiquement les optimisations SEO techniques (sitemap, hreflang multilingue, JSON-LD Organization/Product/FAQ, IndexNow). Cette étape contrôle que tout est en place et active les intégrations Google (Search Console + Merchant Center) pour suivre tes positions et publier tes produits sur Google Shopping."
      magicButton={{
        label: refreshing ? "Rafraîchissement…" : "Rafraîchir l'audit",
    ...
    >
      ...
      <div
        className="mb-6 p-7 rounded-2xl border"
      ...
      >
        <div className="flex items-center gap-6 flex-wrap mb-6">
          ...
          <div className="flex-1 min-w-[260px]">
            ...
            <div className="text-[36px] leading-none text-neutral-900" style={{ fontFamily: "'Fraunces', serif", fontWeight: 500 }}>
              {score} / 100
            </div>
      ...
      {allHandled ? (
        <div className="mb-6 grid grid-cols-1 md:grid-cols-2 gap-3" data-testid="seo-google-readonly">
          <ReadOnlyInfo
            ...
            body={<>Suivi de positions activé automatiquement. Données disponibles 24-48 h après mise en ligne.</>}
          />
          <ReadOnlyInfo
            ...
            body={
              gmcSubAccountId ? (
                ...
                Publications Google Shopping activées après mise en ligne.</>
              ) : (
          ...
          {!gscOk && (
            <div className="p-5 rounded-xl border bg-white" style={{ borderColor: "#E8E2D5" }}>
              ...
              <div className="text-[13px] text-neutral-700 mb-3">
                Connecte Search Console pour suivre tes positions.
              </div>
          ...
          {!merchantOk && (
            <div className="p-5 rounded-xl border bg-white" style={{ borderColor: "#E8E2D5" }}>
              ...
              <div className="text-[13px] text-neutral-700">
                Pour publier tes produits sur Google Shopping, connecte Merchant Center depuis{" "}
