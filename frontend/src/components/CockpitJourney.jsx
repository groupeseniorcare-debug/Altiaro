...
export default function CockpitJourney({ site, onRefresh }) {
  ...
  const steps = [
    ...
    },
    {
      ...
      subtitle: "Recherche sur AliExpress + import en 1 clic (IA enrichit les fiches)",
      done: products >= 5,
      cta: products > 0 ? `${products} produits importés` : "Importer des produits",
      to: `/sites/${site.id}/aliexpress/import`,
    },
    {
      key: "upsells",
      n: 3,
    ...
    },
    {
      ...
      subtitle: "Nom final, logo, couleurs, baseline — injectés dans le template",
      done: hasBrand && hasLogo,
      cta: hasBrand && hasLogo ? "Branding configuré" : "Configurer le branding",
