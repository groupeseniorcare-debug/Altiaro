...
- **Stack** : FastAPI (76 routers modulaires, **404 endpoints** exposés via OpenAPI sur `/api/docs`) + MongoDB motor async + React 19 + Tailwind + Phosphor icons + Framer Motion + recharts
